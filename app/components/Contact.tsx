                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start group">
                    ...
                    <div className="ml-5">
                      ...
                      <p className="text-gray-900 text-lg">
                        <a href="tel:+911234567890" className="transition-colors font-semibold" onMouseEnter={(e) => e.currentTarget.style.color = 'var(--color-brand-dark)'} onMouseLeave={(e) => e.currentTarget.style.color = ''}>
                          +91 1234567890
                        </a>
                      </p>
                    </div>
                  ...
                  <div className="flex items-start group">
                    ...
                    <div className="ml-5">
                      ...
                      <p className="text-gray-900 text-lg">
                        <a href="mailto:info@anmaad.com" className="transition-colors font-semibold" onMouseEnter={(e) => e.currentTarget.style.color = 'var(--color-brand-dark)'} onMouseLeave={(e) => e.currentTarget.style.color = ''}>
                          info@anmaad.com
                        </a>
                      </p>
                    </div>
